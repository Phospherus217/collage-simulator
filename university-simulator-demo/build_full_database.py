# -*- coding: utf-8 -*-
"""
大学四年模拟器 v2.0 - 全系统终极版事件数据库构建脚本 (35+ 核心事件覆盖四大年级 16 个事件集)
"""
...
events = [
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 15 },
        "variable_delta": { "social": 8, "romance": 5 },
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "focus": 8, "academic": 3 }
      }
    ]
  },
  {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 20 },
        "variable_delta": { "skill": 8, "academic": 6, "focus": 4 },
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "academic": 5, "health": 3 }
      }
    ]
  },
  {
    ...
    "max_month": 3,
    "repeatable": False,
    "unlock_condition": { "min_vars": { "social": 30 } },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 20 },
        "variable_delta": { "social": 12, "reputation": 10, "skill": 5, "delivery": 5 },
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "social": 4, "focus": 3 }
      }
    ]
  },
  {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 20 },
        "variable_delta": { "social": 10, "reputation": 6, "focus": -4 },
        "tag_add": ["FLAG_SO_STUDENT_UNION_MEMBER"]
      },
      {
        "choice_id": "B",
  ...
  },
  {
    ...
    "max_month": 5,
    "repeatable": False,
    "unlock_condition": { "ailab_phase": "HIDDEN" },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 1, "EP": 10 },
        "variable_delta": { "ai_depth": 6, "skill": 4, "social": 4 },
        "tag_add": ["FLAG_AI_HINT_AGENT_DEMO"]
      },
      {
        "choice_id": "B",
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 25 },
        "variable_delta": { "academic": 10, "focus": 6, "health": -5 },
        "tag_add": ["FLAG_AC_MATH_RESCUE"]
      },
      {
        "choice_id": "B",
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "academic": 2, "health": 3 }
      }
    ]
  },
  {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 1, "EP": 10 },
        "variable_delta": { "family": 8, "health": 5 },
        "tag_add": ["FLAG_PU_FAMILY_SUPPORT"]
      },
      {
        "choice_id": "B",
  ...
  },
  {
    ...
    "max_month": 9,
    "repeatable": False,
    "unlock_condition": { "min_vars": { "social": 35 } },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 15 },
        "variable_delta": { "romance": 35, "health": 8, "social": 5 },
        "tag_add": ["FLAG_RO_DATING"]
      },
      {
        "choice_id": "B",
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "focus": 8, "academic": 4 }
      }
    ]
  },
  {
    ...
    "max_month": 30,
    "repeatable": True,
    "unlock_condition": { "max_vars": { "family": 40 } },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 30 },
        "variable_delta": { "family": 8, "health": -6, "delivery": 5 },
      ...
      },
      {
        ...
        "cost": { "TU": 0, "EP": 15 },
        "variable_delta": { "health": -12, "social": -5, "focus": -4 }
      }
    ]
  },
  {
    ...
    "max_month": 42,
    "repeatable": True,
    "unlock_condition": { "max_vars": { "health": 35 } },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": -20 },
        "variable_delta": { "health": 15, "focus": 8 }
      },
      {
        "choice_id": "B",
        ...
        "cost": { "TU": 1, "EP": 35 },
        "variable_delta": { "health": -20, "academic": -8, "delivery": -10 }
      }
    ]
  },
  ...
  # ================= 大二学年 (Months 11 ~ 20) =================
  {
    ...
    "max_month": 15,
    "repeatable": False,
    "unlock_condition": { "month_in": [13, 14] },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 45 },
        "variable_delta": { "skill": 15, "delivery": 18, "portfolio": 12, "academic": 8, "health": -12 },
        "tag_add": ["FLAG_AC_SOLO_CARRIER"],
        "resume_entry": {
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 10 },
        "variable_delta": { "academic": 4, "reputation": -3 }
      }
    ]
  },
  {
    ...
    "max_month": 36,
    "repeatable": False,
    "unlock_condition": { "min_vars": { "romance": 35 } },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 20 },
        "variable_delta": { "romance": 15, "reputation": -4, "delivery": -3, "health": 4 },
      ...
      },
      {
        ...
        "cost": { "TU": 2, "EP": 25 },
        "variable_delta": { "delivery": 12, "reputation": 8, "romance": -12, "focus": -5 },
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 25 },
        "variable_delta": { "skill": 10, "ai_depth": 8, "delivery": 5 },
        "route_update": { "ailab": "FORESHADOW" },
        "tag_add": ["FLAG_AI_MET_SENIOR"],
        "resume_entry": {
          "category": "PROJECT_EXP",
  ...
  },
  {
    ...
    "repeatable": False,
    "unlock_condition": {
      "min_vars": { "skill": 30, "portfolio": 15 }
    },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 35 },
        "variable_delta": { "portfolio": 15, "delivery": 12, "skill": 8, "social": 5 },
        "route_update": { "work": "AVAILABLE" },
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 10 },
        "variable_delta": { "academic": 6, "health": 4 }
      }
    ]
  },
  {
    ...
    "max_month": 19,
    "repeatable": False,
    "unlock_condition": { "min_vars": { "academic": 60 } },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 40 },
        "variable_delta": { "portfolio": 15, "research": 12, "reputation": 15, "health": -10 },
        "tag_add": ["FLAG_COMPETITION_NATIONAL_AWARD"],
        "resume_entry": {
          "category": "HONORS",
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "academic": 5, "health": 5 }
      }
    ]
  },
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 30 },
        "variable_delta": { "skill": 12, "ai_depth": 15, "delivery": 8, "reputation": 10 },
        "route_update": { "ailab": "ACTIVE" },
        "tag_add": ["FLAG_AI_LAB_ACTIVE_MEMBER"],
        "resume_entry": {
          "category": "PROJECT_EXP",
          "chain_id": "EXP_AI_LAB_01",
          "stage_contribution": "PARTICIPANT",
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 5 },
        "variable_delta": { "reputation": 10, "focus": 10 },
        "route_update": { "ailab": "EXITED" },
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 30 },
        "variable_delta": { "focus": 15, "academic": 8 },
        "route_update": { "postgrad_exam": "PRIMARY" },
        "tag_add": ["FLAG_GE_PRIMARY_SET"]
      },
      {
        "choice_id": "B",
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 35 },
        "variable_delta": { "research": 18, "portfolio": 10, "reputation": 15 },
        "route_update": { "postgrad_rec": "AVAILABLE" },
        "tag_add": ["FLAG_RE_EXCELLENT_CAMPER"],
        "resume_entry": {
          "category": "RESEARCH",
      ...
      },
      {
        ...
        "cost": { "TU": 1, "EP": 10 },
        "variable_delta": { "academic": 6, "reputation": 5 },
        "route_update": { "postgrad_rec": "AVAILABLE" }
      }
    ]
  },
  {
    ...
    "repeatable": False,
    "unlock_condition": {
      "min_vars": { "portfolio": 35, "skill": 40 }
    },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 4, "EP": 45 },
        "variable_delta": { "portfolio": 20, "delivery": 18, "reputation": 15, "skill": 10 },
        "route_update": { "work": "PRIMARY" },
        "tag_add": ["FLAG_WK_INTERN_RETURN_PASS"],
        "resume_entry": {
          "category": "INTERNSHIP",
      ...
      },
      {
        ...
        "cost": { "TU": 2, "EP": 20 },
        "variable_delta": { "portfolio": 10, "delivery": 8 },
        "route_update": { "work": "AVAILABLE" }
      }
    ]
  },
  ...
  # ================= 大四学年 (Months 31 ~ 42) =================
  {
    ...
    "unlock_condition": {
      "min_vars": { "academic": 80 },
      "route_status": { "postgrad_rec": ["POTENTIAL", "AVAILABLE", "PRIMARY"] }
    },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 2, "EP": 20 },
        "variable_delta": { "academic": 15, "reputation": 20, "research": 15 },
        "route_update": { "postgrad_rec": "COMPLETED" },
        "tag_add": ["FLAG_RE_TOP_OFFER"],
        "resume_entry": {
          "category": "HONORS",
  ...
  },
  {
    ...
    "repeatable": False,
    "unlock_condition": {
      "min_vars": { "portfolio": 45, "skill": 45 },
      "route_status": { "work": ["AVAILABLE", "PRIMARY"] }
    },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 40 },
        "variable_delta": { "reputation": 20, "delivery": 15, "portfolio": 15 },
        "route_update": { "work": "COMPLETED" },
      ...
      },
      {
        ...
        "cost": { "TU": 2, "EP": 25 },
        "variable_delta": { "reputation": 10, "delivery": 10 },
        "route_update": { "work": "COMPLETED" },
  ...
  },
  {
    ...
    "unlock_condition": {
      "ailab_phase": "ACTIVE",
      "min_vars": { "delivery": 60, "reputation": 55, "portfolio": 50 }
    },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 5, "EP": 60 },
        "variable_delta": { "delivery": 20, "ai_depth": 20, "portfolio": 20, "reputation": 20 },
        "route_update": { "ailab": "CORE" },
        "tag_add": ["FLAG_AI_CORE_REAL_BATTLE"],
        "resume_entry": {
          "category": "PROJECT_EXP",
          "chain_id": "EXP_AI_LAB_01",
  ...
  },
  {
    ...
    "repeatable": False,
    "unlock_condition": {
      "route_status": { "postgrad_exam": ["AVAILABLE", "PRIMARY"] }
    },
    "content": {
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 4, "EP": 50 },
        "variable_delta": { "academic": 15, "focus": 15, "health": -10 },
        "route_update": { "postgrad_exam": "COMPLETED" },
        "tag_add": ["FLAG_GE_PASSED_INITIAL"],
        "resume_entry": {
          "category": "HONORS",
    ...
    "choices": [
      {
        ...
        "cost": { "TU": 3, "EP": 30 },
        "variable_delta": { "academic": 12, "reputation": 10, "research": 8 },
        "tag_add": ["FLAG_AC_TOP_THESIS"],
        "resume_entry": {
          "category": "ACADEMIC",
...
with open(r'D:\大学模拟器\university-simulator-demo\data\events.json', 'w', encoding='utf-8') as f:
    json.dump(events, f, ensure_ascii=False, indent=2)

# Write to js/events_embed.js
with open(r'D:\大学模拟器\university-simulator-demo\js\events_embed.js', 'w', encoding='utf-8') as f:
    f.write('/**\n * 大学四年模拟器 v2.0 - 全系统完整事件数据库 (events_embed.js)\n */\n\nwindow.EMBEDDED_EVENTS = ' + json.dumps(events, ensure_ascii=False, indent=2) + ';\n')

print(f'Successfully built full events database! Total events: {len(events)}')
